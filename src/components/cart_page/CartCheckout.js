      ...
      <div className="cart-item-detail pt-2 px-3 pb-3">
        ...
        <form className="mt-3">
          ...
          <div class="form-row">
            <div className="form-group col-md-6">
              <label for="inputCardNumber" className="bold">Card Number <span className="text-danger h5">*</span></label>
              <input type="text" className="form-control" id="inputCardNumber" placeholder="1234 5678 9012 3456" disabled />
            </div>
            <div className="form-group col-md-6">
              <label for="inputNameOnCard" className="bold">Name On Card <span className="text-danger h5">*</span></label>
              <input type="text" className="form-control" id="inputNameOnCard" placeholder="Harrison Ngo" disabled />
            </div>
          </div>
          <div class="form-row">
            <div className="form-group col-md-6">
              <label for="inputCVV" className="bold">CVV <span className="text-danger h5">*</span></label>
              <input type="text" className="form-control" id="inputCVV" placeholder="123" disabled />
            </div>
            <div className="form-group col-md-6">
              <label for="inputNameOnCard" className="bold">Expire Date <span className="text-danger h5">*</span></label>
        ...
        <form>
          <div className="form-group">
            <label for="inputAddress" className="bold">Billing Adress <span className="text-danger h5">*</span></label>
            <input type="text" className="form-control" id="inputAddress" placeholder="64 West Beech Rd" disabled />
          </div>
          <div className="form-row">
            <div className="form-group col-md-6">
              <label for="inputCity" className="bold">City <span className="text-danger h5">*</span></label>
              <input type="text" className="form-control" id="inputCity" disabled placeholder="New York City" />
            </div>
            <div className="form-group col-md-4">
              <label for="inputState" className="bold">State <span className="text-danger h5">*</span></label>
              <input type="text" className="form-control" id="inputState" disabled placeholder="New York" />
            </div>
            <div className="form-group col-md-2">
              <label for="inputZip" className="bold">Zip <span className="text-danger h5">*</span></label>
              <input type="text" className="form-control" id="inputZip" disabled placeholder="10027" />
            </div>
          </div>
          <div className="form-row">
            <div className="form-group col-md-6">
              <label for="inputEmail" className="bold">Email <span className="text-danger h5">*</span></label>
              <input type="text" className="form-control" id="inputEmail" disabled placeholder="example@test.com" />
            </div>
            <div className="form-group col-md-6">
              <label for="inputPhone" className="bold">Phone <span className="text-danger h5">*</span></label>
              <input type="text" className="form-control" id="inputPhone" disabled placeholder="518-212-8504" />
                ...
                //TODO: Prevent access when unsuccessful login
